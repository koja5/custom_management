...
export class HelpComponent implements OnInit {
  ...
  @ViewChild("iconListModal") iconListModal: Modal;
  ...
  addNewModal() {
    ...
    this.topic.iconCss=this.icons[0];
  ...
  chooseIcon(){
    this.helpTopicModal.close();
    this.iconListModal.open();
  }

  closeIconListModal(){
    this.iconListModal.close();
    this.helpTopicModal.open();
  }

  choosenIcon(icon){
    this.topic.iconCss=icon;
    (document.querySelector('#'+icon) as HTMLElement).parentElement.parentElement.style.boxShadow='10px 10px lightblue !important';
  }
