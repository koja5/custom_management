...
export class BaseDateComponent implements OnInit {
  ...
  getComplaint() {
    this.service.getComplaintForCustomer(this.data.id).subscribe(
      data => {
  ...
  getTherapy() {
    this.service.getTherapyForCustomer(this.data.id).subscribe(
      data => {
  ...
  addTherapy(therapy) {
    ...
    this.complaintData.date = new Date();
    console.log(this.complaintData);
    this.service.addTherapy(this.complaintData).subscribe(
      data => {
        if(data) {
          this.getTherapy();
          this.therapy.close();
